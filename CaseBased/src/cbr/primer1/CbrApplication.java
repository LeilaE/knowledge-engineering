...
public class CbrApplication implements StandardCBRApplication {
	...
	public void configure() throws ExecutionException {
		...
		simConfig.addMapping(new Attribute("price", TransactionDescription.class), new Interval(1000));
		simConfig.addMapping(new Attribute("realEstateDescription", TransactionDescription.class), new Average());
		simConfig.addMapping(new Attribute("age", RealEstateDescription.class), new Interval(5));
