...
import model.TreatmentDescription;
...
public class CbrApplication implements StandardCBRApplication {
	...
	public void configure() throws ExecutionException {
		...
		simConfig.addMapping(new Attribute("diagnosis", TreatmentDescription.class), new Equal());
		simConfig.addMapping(new Attribute("gender", TreatmentDescription.class), new Equal());
		simConfig.addMapping(new Attribute("age", TreatmentDescription.class), new Interval(50));
		
		//ovo pokusavam da uporedim sa drugim slucajevima pa zato ne stavljam da se racuna verovatnoca
	...
	public static void main(String[] args) {
		...
		try {
			...
			TreatmentDescription trDescription = new TreatmentDescription();
